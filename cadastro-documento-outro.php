...
<section class="section_cadastro-doc">
    ...
    <h1 style="padding-left:15px;margin-bottom:50px;">Cadastro de outros tipos de documentos</h1>

    <form action="" method="post" enctype="multipart/form-data" class="form_cadastro-doc">
        <div class="form_cadastro-doc-infos">
            <input type="text" placeholder="Tipo do documento" style="margin-bottom: 12px;">
